			...
			if (x < number) or (number == 0):
				...
				if (message == 'dieing'):
					if (pub_num == owner[0]):
						...
						print(
							" Trying to connect to the publisher with port number %s and topic %s" % (owner[0], topic))
						while True:
							event = dict(poller.poll(10))
							print('waiting..............................')
							if socket_sub3 in event:
								...
								if (message4 == 'dieing'):
									...
									print(
										"Trying to connect to publisher with port number %s and topic %s" % (owner[2]))
									while True:
										event = dict(poller.poll(10))
										print('waiting..............................')
